...
Website interaktif untuk Nova Core Agent terverifikasi di Billions TEE
...
1. Clone the repository:
   ```bash
   git clone https://github.com/xenon231tech/nova-agent-24.git
   cd nova-agent-24
   ```
...
3. Website will be live at: `https://xenon231tech.github.io/nova-agent-24`

### Vercel
1. Connect repository to Vercel
2. Deploy automatically
3. Website will be live at: `https://nova-agent-24.vercel.app`

### Netlify
1. Connect repository to Netlify
2. Deploy automatically
3. Website will be live at: `https://nova-agent-24.netlify.app`
